...
!(function (t, e) {
        ...
        if ("function" == typeof __webpack_require__)
            ...
            if (void 0 !== require.resolve)
                ...
                void 0 !== require.specified &&
                    (D = require.specified("codemirror"));
    var F =
    ...
    function q(t) {
        return (
            t &&
            /^BR|^IMG|^HR|^IFRAME|^BUTTON|^INPUT/.test(t.nodeName.toUpperCase())
        );
    }
    function K(t) {
        return (
    ...
    function Pt(t) {
        var e = function (t, o) {
                ...
                if (Nt.isText(t)) {
                    ...
                    if (((n = t.childNodes[o] || t), Nt.isText(n)))
                        return e(n, 0);
                    (o = 0), (i = !1);
                }
            ...
            return (
                (e.prototype.nativeRange = function () {
                    ...
                    return (
                        e.setEndPoint(
                            "EndToEnd",
                            Pt({ node: this.ec, offset: this.eo })
                        ),
                        e
                    );
                }),
                        ...
                        Nt.walkPoint(
                            ...
                            function (e) {
                                ...
                                Nt.isEditable(e.node) ||
                                    (n
                                        ? (Nt.isLeftEdgePoint(e) &&
                                              a.push(e.node),
                                          Nt.isRightEdgePoint(e) &&
                                              N.contains(a, e.node) &&
                                              (i = e.node))
                                        : (i = o
                                              ? Nt.ancestor(e.node, t)
                                              : e.node),
                                    i && t(i) && s.push(i));
                            },
                            !0
                ...
                (e.prototype.wrapBodyInlineWithPara = function () {
                    ...
                    if (Nt.isInline(o.sc)) {
                        ...
                        (t = N.last(n)),
                            Nt.isInline(t) ||
                                (t = n[n.length - 2] || o.sc.childNodes[o.so]);
        ...
        Ft = (function () {
            ...
            return (
                ...
                (e.prototype.stylePara = function (e, o) {
                    t.each(
                        e.nodes(Nt.isPara, { includeAncestor: !0 }),
                        function (e, n) {
                            t(n).css(o);
                        }
                    );
                        ...
                        return a.map(function (e) {
                            ...
                            return (
                                t.each(i, function (t, e) {
                                    Nt.appendChildNodes(n, e.childNodes),
                                        Nt.remove(e);
                                }),
                                N.head(o)
                            );
                ...
                (e.prototype.current = function (e) {
                    ...
                    return (
                        (n.anchor =
                            e.isOnAnchor() && Nt.ancestor(e.sc, Nt.isAnchor)),
                ...
                (e.prototype.insertParagraph = function (e) {
                    ...
                    if (i) {
                        ...
                        if (
                            ...
                            (r = r.concat(
                                Nt.listDescendant(n, Nt.isEmptyAnchor)
                            )),
                                t.each(r, function (t, e) {
                                    Nt.remove(e);
                                }),
        ...
        Ut = (function () {
            ...
            return (
                ...
                (e.prototype.addRow = function (e, o) {
                    ...
                    if ("top" === o) i.before(s);
                        ...
                        if (n.rowSpan > 1) {
                            ...
                            return void t(t(i).parent().find("tr")[p]).after(
                                t(s)
                            );
                        }
                        i.after(s);
                ...
                (e.prototype.createTable = function (e, o, n) {
                    ...
                    return (
                        n && n.tableClassName && d.addClass(n.tableClassName),
                        d[0]
                    );
                }),
        ...
        jt = (function () {
            function e(e) {
                ...
                (this.insertParagraph = this.wrapCommand(function () {
                    ...
                    (this.insertHorizontalRule = this.wrapCommand(function () {
                        ...
                        t.nextSibling &&
                            Ht.create(t.nextSibling, 0).normalize().select();
                    })),
                    ...
                    (this.createLink = this.wrapCommand(function (e) {
                        ...
                        t.each(l, function (e, o) {
                            t(o).attr("href", n),
                                r
                                    ? t(o).attr("target", "_blank")
                                    : t(o).removeAttr("target");
                        });
                        var d = Ht.createFromNodeBefore(
                                N.head(l)
                            ).getStartPoint(),
                    ...
                    (this.insertTable = this.wrapCommand(function (t) {
                        ...
                        o.createRange()
                            .deleteContents()
                            .insertNode(
                                o.table.createTable(e[0], e[1], o.options)
                            );
                    })),
            ...
            return (
                    ...
                    return (
                        ...
                        (void 0 === e ||
                            !(
                                ...
                                e.metaKey ||
                                N.contains(
                                    [At.code.BACKSPACE, At.code.DELETE],
                                    e.keyCode
                                )
                            )) &&
                ...
                (e.prototype.getLinkInfo = function () {
                    ...
                    return (
                        o.length &&
                            (n.isNewWindow = "_blank" === o.attr("target")),
                        n
                    );
                }),
    ...
    var Vt = (function () {
            ...
            return (
                ...
                (t.prototype.activate = function () {
                    ...
                    if (
                        ...
                        var e = Ot.fromTextArea(
                            this.$codable[0],
                            this.options.codemirror
                        );
                        if (this.options.codemirror.tern) {
                            var o = new Ot.TernServer(
                ...
                (e.prototype.update = function (e) {
                    ...
                    if ((this.context.invoke("imagePopover.update", e), o)) {
                        var i = t(e),
                            ...
                            s = {
                                left:
                                    r.left + parseInt(i.css("marginLeft"), 10),
                                ...
                                e.ui.dropdown({
                                    ...
                                    template: function (t) {
                                        "string" == typeof t &&
                                            (t = {
                                                tag: t,
                                                title: e.lang.style.hasOwnProperty(
                                                    t
                                                )
                                                    ? e.lang.style[t]
                                                    : t,
                    ...
                    if (
                        (this.updateBtnStates(n, {
                            ...
                            ".note-btn-strikethrough": function () {
                                return (
                                    "strikethrough" === i["font-strikethrough"]
                                );
                            },
                        }),
                        i["font-family"])
                ...
                (e.prototype.createVideoNode = function (e) {
                    ...
                    if (n && 11 === n[1].length) {
                        ...
                        o = t("<iframe>")
                            ...
                            .attr(
                                "src",
                                "https://instagram.com/p/" + i[1] + "/embed/"
                            )
                            .attr("width", "612")
                            .attr("height", "710")
                            .attr("scrolling", "no")
        ...
        ce = (function () {
            function e(e) {
                ...
                (this.context = e),
                    ...
                    (this.hints = t.isArray(this.hint)
                        ? this.hint
                        : [this.hint]),
                    (this.events = {
            ...
            return (
                ...
                (e.prototype.handleKeyup = function (t) {
                    ...
                    if (
                        !N.contains(
                            [At.code.ENTER, At.code.UP, At.code.DOWN],
                            t.keyCode
                        )
                    ) {
                        var o = this.context
        ...
        de = (function () {
            ...
            return (
                ...
                (e.prototype.createInvokeHandlerAndUpdateState = function (
                    t,
                    e
                ) {
                    var o = this;
