                    ...
                    <div class="banner-carousel owl-carousel owl-theme">
                        @foreach ($sliders as $slider)
                            ...
                            <div class="slide-item"
                                style="background-image: url({{ asset('uploads/slider/' . $slider->image_path) }});">
                                <div class="container">
                                        ...
                                        <div class="link-box">
                                            ...
                                            @if (isset($page_contact))
                                                <a href="{{ route('contact') }}"
                                                    class="theme-btn btn-style-one">{{ __('common.contact_us') }}</a>
                                            @endif

                                            @if (isset($slider->link))
                                                <a href="{{ $slider->link }}" target="_blank"
                                                    class="theme-btn btn-style-two">{{ __('common.read_more') }}</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                ...
                @if (isset($about))
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 wow fadeInRight animated">
                            <div class="inner-box">
                                <div class="text">
                                    {!! \Illuminate\Support\Str::limit($about->description, 1500) !!} <br />
                                </div>
                                <br />
                                @php
                                ...
                                @if (isset($page_about))
                                    <div class="link-box">
                                        <a href="{{ route('about') }}"
                                            class="theme-btn btn-style-three">{{ __('common.read_more') }}</a>
                                    </div>
                                @endif
                            </div>
                            {{-- </div>
                    ...
                    <div class="services-carousel owl-carousel owl-theme">
                        @foreach ($services as $service)
                            ...
                            <div class="service-block wow fadeInDown">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure><img src="{{ asset('uploads/service/' . $service->image_path) }}"
                                                alt="{{ $service->title }}" /></figure>
                                        <div class="overlay-box"><a
                                                href="{{ route('service.single', $service->slug) }}">{{ __('common.read_more') }}</a>
                                        </div>
                                    </div>
                                    <div class="lower-content">
                                        <h3><a
                                                href="{{ route('service.single', $service->slug) }}">{{ $service->title }}</a>
                                        </h3>
                ...
                <div class="container">
                    ...
                    <div class="filters row clearfix">
                        ...
                        <ul class="filter-tabs filter-btns clearfix">
                            ...
                            @foreach ($portfolio_categories as $portfolio_category)
                                <li class="filter" data-role="button" data-filter=".{{ $portfolio_category->slug }}">
                                    {{ $portfolio_category->title }}</li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="row clearfix items-container">
                        ...
                        @foreach ($portfolios as $portfolio)
                            ...
                            <div
                                class="default-portfolio-item mix masonry-item all 
                        @foreach ($portfolio->categories as $category)
                            {{ $category->slug }} @endforeach
                     col-lg-4 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    <figure class="image-box"><img
                                            src="{{ asset('uploads/portfolio/' . $portfolio->image_path) }}"
                                            alt="{{ $portfolio->title }}"></figure>
                                    <!--Overlay Box-->
                    ...
                    @if (isset($page_portfolio))
                        <div class="load-more-btn text-center">
                            <a href="{{ route('portfolios') }}"
                                class="theme-btn btn-style-four">{{ __('common.view_more') }}</a>
                        </div>
                    @endif
                </div>
            </div>
                    ...
                    @foreach ($testimonials as $testimonial)
                        ...
                        <div class="testimonial-block">
                            <div class="inner-box">
                                <div class="image-box">
                                    <div class="thumb"><img
                                            src="{{ asset('uploads/testimonial/' . $testimonial->image_path) }}"
                                            ...
                                            <div class="image-box col-lg-6 col-md-6 col-sm-12">
                                                <div class="image">
                                                    <figure class="image"><img
                                                            src="{{ asset('uploads/article/' . $article->image_path) }}"
                                                            alt="{{ $article->title }}"></figure>
                                                    <div class="overlay-box"><a
                                                            href="{{ route('blog.single', $article->slug) }}"
                                                            class="link-btn">{{ __('common.read_more') }}</a></div>
                                                </div>
                                            </div>
                ...
                <div class="sponsors-outer">
                    ...
                    <ul class="sponsors-carousel owl-carousel owl-theme">
                        @foreach ($clients as $client)
                            <li class="slide-item">
                                <figure class="image-box"><a href="{{ $client->link }}" target="_blank"><img
                                            src="{{ asset('uploads/client/' . $client->image_path) }}"
                                            alt="{{ $client->title }}"></a></figure>
                            </li>
                        @endforeach
                    </ul>
                </div>
